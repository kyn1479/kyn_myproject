...
import com.kyn.myproject.demo.common.util.EntityBeanUtil;
...
public class RememberMeManager extends CookieRememberMeManager {
    ...
    protected byte[] serialize(PrincipalCollection principals) {
        ...
        SimplePrincipalCollection collection = new SimplePrincipalCollection(principal, MyRealm.class.getName());
